...
async def test_real_url():
    ...
    try:
        ...
        async with detector:
            ...
            print("   Checking segment 81 (known)...")
        ...
        async with detector:
            ...
            for i, (_url, exists) in enumerate(zip(test_urls, batch_results), 79):
...
def main():
    ...
    print("=" * 80)
    print(
        "This script tests the provided HLS URL to verify our implementation works correctly."
    )
    ...
    try:
        ...
        if success:
            ...
            if template_success:
                ...
                print(
                    'python -m src.hls_downloader.cli "https://dh5wswx02.v.cntv.cn/asp/h5e/hls/1200/0303000a/3/default/6f3ab539680c4b359d857b4c73a824eb/{}.ts"'
                )
            else:
