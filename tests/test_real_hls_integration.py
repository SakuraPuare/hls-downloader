...
class TestRealHLSIntegration:
    ...
    async def test_segment_url_generation_real(self, detector, real_hls_url):
        ...
        test_cases = [
            (1, "https://dh5wswx02.v.cntv.cn/asp/h5e/hls/1200/0303000a/3/default/6f3ab539680c4b359d857b4c73a824eb/1.ts"),
            (81, "https://dh5wswx02.v.cntv.cn/asp/h5e/hls/1200/0303000a/3/default/6f3ab539680c4b359d857b4c73a824eb/81.ts"),
            (100, "https://dh5wswx02.v.cntv.cn/asp/h5e/hls/1200/0303000a/3/default/6f3ab539680c4b359d857b4c73a824eb/100.ts"),
        ]
        
        for segment_num, expected_url in test_cases:
            generated_url = detector._generate_segment_url(base_url, pattern, segment_num)
