        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(manager, '_detector') as mock_detector:
                ...
                with patch.object(manager, '_downloader') as mock_downloader:
                    ...
                    mock_downloader_instance.download_segments.side_effect = first_time_download
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(manager, '_detector') as mock_detector:
                ...
                with patch.object(manager, '_downloader') as mock_downloader:
                    ...
                    mock_downloader_instance.download_segments.side_effect = experienced_download
                    mock_downloader.__aenter__.return_value = mock_downloader_instance
                    ...
                    with patch.object(manager, '_progress_display'):
                        ...
                        assert "merged" not in result or result["merged"] == False
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(manager, '_detector') as mock_detector:
                ...
                with patch.object(manager, '_downloader') as mock_downloader:
                    ...
                    mock_downloader_instance.download_segments.side_effect = unstable_download
                    mock_downloader.__aenter__.return_value = mock_downloader_instance
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(manager, '_detector') as mock_detector:
                ...
                with patch.object(manager, '_downloader') as mock_downloader:
                    ...
                    mock_downloader_instance.download_segments.side_effect = corruption_recovery_download
                    mock_downloader.__aenter__.return_value = mock_downloader_instance
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(manager, '_detector') as mock_detector:
                ...
                with patch.object(manager, '_downloader') as mock_downloader:
                    ...
                    mock_downloader_instance.download_segments.side_effect = disk_space_download
                    mock_downloader.__aenter__.return_value = mock_downloader_instance
...
class TestConfigurationScenarios:
    ...
    async def test_configuration_persistence(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert manager.config.auto_merge == False
            assert manager.config.cleanup_segments == False
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(manager, '_detector') as mock_detector:
                ...
                with patch.object(manager, '_downloader') as mock_downloader:
                    ...
                    mock_downloader_instance.download_segments.side_effect = single_download
                    mock_downloader.__aenter__.return_value = mock_downloader_instance
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(manager, '_detector') as mock_detector:
                ...
                with patch.object(manager, '_downloader') as mock_downloader:
                    ...
                    mock_downloader_instance.download_segments.side_effect = unicode_download
                    mock_downloader.__aenter__.return_value = mock_downloader_instance
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(manager, '_detector') as mock_detector:
                ...
                with patch.object(manager, '_downloader') as mock_downloader:
                    ...
                    mock_downloader_instance.download_segments.side_effect = long_url_download
                    mock_downloader.__aenter__.return_value = mock_downloader_instance
