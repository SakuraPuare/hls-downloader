...
from src.hls_downloader.state_manager import StateManager, DownloadState
...
class TestStateManager:
    ...
    def test_init(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert manager.backup_file == Path(temp_dir) / ".hls_download_state.backup.json"
    ...
    def test_save_and_load_state(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert loaded_state.config.max_concurrent == original_state.config.max_concurrent
            ...
            assert loaded_state.segments[0].downloaded == original_state.segments[0].downloaded
            assert loaded_state.stats.total_segments == original_state.stats.total_segments
    ...
    def test_update_state_progress(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert state.segments[0].downloaded == True
            assert state.segments[1].downloaded == False
