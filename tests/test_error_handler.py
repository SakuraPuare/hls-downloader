...
class TestErrorHandler:
    ...
    @pytest.mark.asyncio
    async def test_handle_with_retry_success_first_attempt(
    ...
    @pytest.mark.asyncio
    async def test_handle_with_retry_success_after_retries(
        self, error_handler, sample_segment
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_with_retry_permanent_failure(
        self, error_handler, sample_segment
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_with_retry_delay_between_attempts(
        self, error_handler, sample_segment
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_with_retry_resets_count_on_success(
        self, error_handler, sample_segment
    ):
