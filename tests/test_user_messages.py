...
class TestUserMessageDisplay:
    ...
    def test_show_error_with_technical_details(self, message_display, sample_segment, capsys):
    ...
    def test_get_friendly_error_type(self, message_display):
        ...
        assert message_display._get_friendly_error_type("network_error") == "Network errors"
        assert message_display._get_friendly_error_type("timeout_error") == "Timeout errors"
        assert message_display._get_friendly_error_type("http_error") == "HTTP errors"
        assert message_display._get_friendly_error_type("file_system_error") == "File system errors"
        assert message_display._get_friendly_error_type("integrity_error") == "File corruption errors"
        assert message_display._get_friendly_error_type("unknown_error") == "Unknown errors"
        assert message_display._get_friendly_error_type("custom_error") == "Custom Error"
