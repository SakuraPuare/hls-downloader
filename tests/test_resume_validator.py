...
class TestResumeValidator:
    ...
    async def test_validate_segments_basic(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            async with validator:
                valid, invalid, missing = await validator.validate_segments(
    ...
    async def test_deep_validate_segments_success(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(validator, "_client") as mock_client:
                ...
                valid, invalid = await validator.deep_validate_segments(
                    [segment], segments_dir
                )
    ...
    def test_cleanup_invalid_files(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            removed_count = validator.cleanup_invalid_files(
                invalid_segments, segments_dir
            )
    ...
    def test_get_resume_summary_all_valid(self):
        ...
        assert not summary["can_resume"]  # Nothing to download
