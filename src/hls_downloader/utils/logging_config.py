...
def log_download_start(url: str, output_dir: str, config: dict[str, Any]) -> None:
...
def log_error_summary(error_summary: dict[str, Any]) -> None:
    ...
    if error_summary["total_errors"] > 0:
        logger.bind(event="error_summary", **error_summary).warning(
