...
class StateManager:
    ...
    def get_state_info(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            file_to_check = self.state_file if self.state_file.exists() else self.backup_file
            ...
            return {
                ...
                "downloaded_segments": state_dict.get("stats", {}).get("downloaded_segments", 0),
                "failed_segments": state_dict.get("stats", {}).get("failed_segments", 0),
            }
    ...
    def _dict_to_state(self, state_dict: Dict[str, Any]) -> DownloadState:
        ...
        try:
            ...
            required_fields = ["url", "output_dir", "config", "segments", "stats", "status"]
    ...
    def update_state_segments(self, state: DownloadState, segments: List[SegmentInfo]) -> None:
